...
export default function Activity(prop) {
  ...
  return (
    <>
      <div className="row">
        <div
          className="jumbotron jumbotron-fluid col-12 widthjumbo"
          style={{ padding: "20px", paddingLeft: "0.5px" }}
        >
          <div className="containerjumbo">
            <div className="row">
              <div className="col-1">
                <button onClick={(e) => changeEdit(e)} className="icon1">
          ...
          <div className="containerjumbo  my-4">
            <h1 className="display-9">Activity LOG </h1>
          </div>
          <div className="containerjumbo">
      ...
      <div className="row">
        ...
        <div className="col-4 column1 " style={{ display: edit ? "" : "none" }}>
                ...
                <div className="row">
                  <div className="col-sm-12">
                    <p className="mb-0 mx-3">
                      <h5 className="mx-2" style={{textAlign:"center"}}>Time stamp and details </h5>
                    </p>
                  </div>
                  <div className="col-12">
                        ...
                        serviceList.map((singleService, index) => (
                          <>
                            <p key={index } style={{margin:"20px"}}>
                              <div className="row">
                                <div className="col-6">
                                {singleService.service2 && (
                                <h3>{singleService.service2}</h3>
                              )}
                                
                                </div>
                                <div className="col-6">
                                {singleService.service && (
                                <p style={{display:"inline", alignItems:"flex-end",marginLeft:"10px"}}>{singleService.service}</p>
                              )}
                              
                                {singleService.service4 && (
                                <p style={{display:"inline", alignItems:"flex-end",marginLeft:"10px"}}>{singleService.service4}</p>
                              )}
                                </div>
                              </div>
                              ...
                              {singleService.service3 && (
                                <p>{singleService.service3}</p>
                              )}
                            </p>
                            <hr />
                          </>
